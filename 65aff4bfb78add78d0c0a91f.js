...
Command: npx gltfjsx@6.2.16 public/models/65aff4bfb78add78d0c0a91f.glb 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/65aff4bfb78add78d0c0a91f.glb')
  return (
...
useGLTF.preload('/65aff4bfb78add78d0c0a91f.glb')
